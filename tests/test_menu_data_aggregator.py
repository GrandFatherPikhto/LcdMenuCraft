...
def test_processor_delegates_to_single_aggregator(monkeypatch, project_root, config_path, menu_override_path):
...
def test_aggregator_matches_processor_results(monkeypatch, project_root, config_path, menu_override_path):
